...
#### General:
    ...
    iv. Account dropdown is shown when hovered over, able to logout from there.
    v. Once out of view of navigatin bar, you can scroll down to make the alternate navigation bar appear.

    Problems/Bugs:
    i. Account dropdown list is not accessible in mobile view.

#### Home/Landing Page: [index.html]

    i. A pop-up will appear upon landing on the page, able to cancel.
    ii. Slider Banner is able to slide using either mouse or the slider provided.
    iii. As you scroll through the page, each section will load up.
    iv. Try to add the product at "Trending Section" to cart and made sure that it worked.

#### Shop Page: [shop.html]

    i. Filtering Option are working and able to filter via "All Products", "Newest", "Albums" & "Cases" .
    ii. All products are able to be added into the shopping bag/cart, able to adjust quantity, the total is also calculated correctly no matter the amount.
    iii. Search Bar is working and is able to search items by their names.
    iv. 4 of the items are linked to their own product pages, and is working.

    Problems/Bugs:
    i. Shopping bag/cart & Search Bar not accessible in mobile view.

#### Gallery Page: [gallery.html]

    i. Sections are all working.
    ii. images are able to be clicked upon to provide a better view of the image, and is able to close using the cross button provided.

#### Member Profiles Pages: [profile-****.html]

    Member Profiles[^1]:
    i. Dropdown list in Navigation Bar is working well with all pages.
    ii. In each member profile page, click on any of the 4 boxes of any members, will bring you to the member that you chose.
    iii. "Read More" button is linked to a new tab, connect to the main source.

    Problems/Bugs:
    i. Members boxes are abit buggy in mobile view.

    [^1]: profile-bangchan.html
          profile-leeknow.html
          profile-changbin.html
          profile-hyunjin.html
          profile-han.html
          profile-felix.html
          profile-seungmin.html
          profile-jeongin.html
...
#### Login/Register Page: [login.html] & [register.html]
    ...
    i. Try to press enter after filling in email or passwords, there should be "Please Fill out this Field" appearing.
    ii. Password will appear as dots while you types in their password to be more private.
    iii. Click on "Create an Account" or "Already a Member?" to access either login.html or register.html.

    Problems/Bugs: 
    i. Able to just access index.html by clicking on "Login" or "Register" button.
...
Media:
- Member Profiles:
    - [KProfiles - Stray Kids](https://kprofiles.com/stray-kids-members-profile/); used for all the members' content.
- Product Images:
    - [JYP SHOP](https://en.thejypshop.com); (Have edited the images for my own shop)

Acknowledgements:
- [JYP SHOP](https://en.thejypshop.com); taken for inspiration generally.
